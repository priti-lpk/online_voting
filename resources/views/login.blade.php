            ...
            <div class="card card-login mx-auto mt-5">
                ...
                <div class="card-body">
                    <form method="post" action="{{ URL::to('/checklogin') }}">
                        ...
                        <div class="form-group">
                            <div class="form-label-group">
                                <input type="text" id="inputEmail" class="form-control" name="email_id" placeholder="Email address" required="required" autofocus="autofocus">
                    ...
                    <div class="text-center">
                        <a class="d-block small mt-3" href="{{ url('register') }}" style="color: #007bff;">Register an Account</a>
